...
app.config['MYSQL_DATABASE_HOST'] = 'stevie-database.cfa2hqarnyfe.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Stevie_1'
app.config['MYSQL_DATABASE_DB'] = 'stevie'
